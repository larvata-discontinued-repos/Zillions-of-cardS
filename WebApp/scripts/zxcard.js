...
getRaceIdByName = function(race) {
  var raceList;
  raceList = ["勇者", "巨兽", "技师", "神兽", "荣光龙", "战斗服", "金属要塞", "人鱼", "杀人机械", "齿轮龙", "天使", "守护者", "圣兽", "猫妖精", "神使龙", "魔人", "捕食者", "不死者", "拷问刑具", "残酷龙", "蓬莱", "兽化人", "叶人", "花虫", "藤蔓龙", "魔人/猫妖精", "回转无添丸", "拉哈鲁", "玛奥", "拉兹贝莉露", "中BOSS", "佩妲", "泽罗凯恩", "史黛拉", "莱德马格纳斯", "泽塔", "亚莎纪", "阿迪鲁", "罗萨莉", "阿库塔雷", "风海纯也", "小暮宗一郎", "基利亚", "露琪璐", "北条纱希", "芙蓉", "莉莉艾尔", "阿尔蒂娜", "普莉耶", "普拉姆", "塞拉菲", "玛利艾尔", "朱庇艾尔", "姬神", "如月", "兔莉雅", "艾多娜", "瓦尔巴特杰", "死亡子", "风花", "虚空之暗", "阿露露", "菲蕾丝", "玛琼莉塔", "普利尼", "玛洛妮", "亚修", "梅塔莉卡", "百骑兵", "碧丝可", "迷宫小姐", "阿露露", "朱庇艾尔", "玛利艾尔", "菲蕾丝", "露琪璐", "史黛拉", "泽塔", "佩塔", "姬神", "如月", "基利亚", "兔莉雅", "塞拉菲", "莱德马格纳斯", "虚空之暗", "泽罗凯恩", "库里斯特", "风海纯也", "小暮宗一郎", "北条纱希", "美音", "涅札莉雅", "阿尔雷奇诺", "拉比莉・拉鲁拉・拉", "瓦莲婷", "库萝耶"];
  switch (language_id) {
    case "2":
      race = $.t2s(race);
  }
